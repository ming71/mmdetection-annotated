# Notes!!
It seems that tremendous changes have been made on codebase , I'm rewriting the instruction for present version and will update soon.   
# mmdetection-annotated 
**Notice** : Still to be contunued....~~I'm back again , and concentrate on it now.Focused on some experiments recently , I may postpone updates on training parts.To be contunued....(well,I promise to finish the rest work before **Jul**.Blame it on examinations...)~~</br>
## Introduction
