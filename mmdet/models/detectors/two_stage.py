...
# 注意多继承的继承顺序，是广度优先，通过__mro__内置方法可以查看
# 但是后面几个都没有构造函数
...
class TwoStageDetector(BaseDetector, RPNTestMixin, BBoxTestMixin,
    ...
    # 训练过程的前向传播计算 
    # 为了防止无意篡改中间特征层导致难以查错，，中间特征的计算全部是tuple形式进行传递
    ...
    # 检测过程的前向传播forward调用的函数，通过最原始的nn.Module到父类BaseDetector的forward，继续由底层 层层向上调用到这里
